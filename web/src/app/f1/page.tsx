  ...
  return (
    <main className="min-h-screen bg-[#0e0e10] text-[#efeff1]">
      ...
      <section className="relative overflow-hidden bg-[#0e0e10] pt-28 sm:pt-36 lg:pt-40 pb-16 sm:pb-24 min-h-[calc(100vh+50px)] sm:min-h-screen">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0" style={{
            backgroundImage: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(220,38,38,0.15) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 30% 20%, rgba(220,38,38,0.1) 0%, transparent 50%), radial-gradient(ellipse 60% 40% at 70% 20%, rgba(220,38,38,0.1) 0%, transparent 50%)'
          }} />
          
          <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
            <line className="flow-line" x1="0" y1="200" x2="100" y2="200" stroke="#ef4444" strokeWidth="1" opacity="0.2"/>
            <line className="flow-line-delay-1" x1="0" y1="240" x2="80" y2="240" stroke="#ef4444" strokeWidth="1" opacity="0.15"/>
            <line className="flow-line-delay-2" x1="0" y1="180" x2="60" y2="180" stroke="#ef4444" strokeWidth="1" opacity="0.1"/>
            <line className="flow-line" x1="0" y1="280" x2="120" y2="280" stroke="#fff" strokeWidth="1" opacity="0.1"/>
            <line className="flow-line-delay-1" x1="0" y1="260" x2="90" y2="260" stroke="#fff" strokeWidth="1" opacity="0.08"/>
          </svg>
            ...
            <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 1200 400">
              <defs>
                <pattern id="asphalt" x="0" y="0" width="40" height="20" patternUnits="userSpaceOnUse">
                  ...
                  <line x1="0" y1="19" x2="40" y2="19" stroke="#2a2a2a" strokeWidth="1"/>
                  <line x1="20" y1="0" x2="20" y2="20" stroke="#333" strokeWidth="0.5" strokeDasharray="4 2"/>
                </pattern>
                <pattern id="raceLine" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                  <rect width="100" height="100" fill="url(#asphalt)"/>
                  <path d="M0 80 Q25 75, 50 80 T100 80" stroke="#ef4444" strokeWidth="3" fill="none" opacity="0.6"/>
                  <path d="M0 60 Q25 55, 50 60 T100 60" stroke="#fff" strokeWidth="2" fill="none" opacity="0.4"/>
                </pattern>
              </defs>
              ...
              <g className="animate-road">
                <line x1="0" y1="320" x2="1200" y2="320" stroke="#ef4444" strokeWidth="4" stroke-dasharray="40 40"/>
              </g>
              <g className="animate-road-white">
                <line x1="0" y1="350" x2="1200" y2="350" stroke="#fff" strokeWidth="2" stroke-dasharray="40 40"/>
              </g>
            </svg>
          ...
          <div className="absolute inset-x-0 top-[5%] sm:top-[8%] lg:top-[10%] flex justify-center">
            <div className="text-center px-4">
              ...
              <div className="flex items-end justify-center gap-2 mt-4">
                <svg className="opacity-40 sm:opacity-50 -rotate-12" width="50" height="100" viewBox="0 0 50 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <pattern id="checker-left-f1" x="0" y="0" width="12.5" height="12.5" patternUnits="userSpaceOnUse">
                      <rect width="12.5" height="12.5" fill="white"/>
                      <rect width="6.25" height="6.25" fill="#111"/>
                      <rect x="6.25" y="6.25" width="6.25" height="6.25" fill="#111"/>
                    </pattern>
                    <clipPath id="flag-clip-left">
                      <path d="M48,5 L2,8 L0,75 L46,78 Z" />
                    </clipPath>
                  </defs>
                  <g className="animate-flag-cloth-right" clip-path="url(#flag-clip-left)">
                    <rect x="0" y="0" width="50" height="80" fill="url(#checker-left-f1)"/>
                  </g>
                  <line x1="46" y1="0" x2="46" y2="100" stroke="#888" strokeWidth="3" strokeLinecap="round"/>
                  <line x1="46" y1="0" x2="46" y2="100" stroke="#aaa" strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/>
                  <circle cx="46" cy="2" r="4" fill="#888" stroke="#666" strokeWidth="0.5"/>
                </svg>
                <svg className="opacity-40 sm:opacity-50 rotate-12" width="50" height="100" viewBox="0 0 50 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <pattern id="checker-right-f1" x="0" y="0" width="12.5" height="12.5" patternUnits="userSpaceOnUse">
                      <rect width="12.5" height="12.5" fill="white"/>
                      <rect width="6.25" height="6.25" fill="#111"/>
                      <rect x="6.25" y="6.25" width="6.25" height="6.25" fill="#111"/>
                    </pattern>
                    <clipPath id="flag-clip-right">
                      <path d="M2,5 L48,8 L50,75 L4,78 Z" />
                    </clipPath>
                  </defs>
                  <g className="animate-flag-cloth" clip-path="url(#flag-clip-right)">
                    <rect x="0" y="0" width="50" height="80" fill="url(#checker-right-f1)"/>
                  </g>
                  <line x1="4" y1="0" x2="4" y2="100" stroke="#888" strokeWidth="3" strokeLinecap="round"/>
                  <line x1="4" y1="0" x2="4" y2="100" stroke="#aaa" strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/>
                  <circle cx="4" cy="2" r="4" fill="#888" stroke="#666" strokeWidth="0.5"/>
                </svg>
              </div>
      ...
      <section className="relative bg-[#1a1515] py-16 sm:py-20 lg:py-28">
        <div className="absolute inset-0" style={{ backgroundImage: 'linear-gradient(rgba(220,38,38,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(220,38,38,0.05) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
      ...
      <section className="relative bg-[#0f0d0d] py-16 sm:py-20 lg:py-28">
        <div className="absolute inset-0 opacity-30" style={{ backgroundImage: 'radial-gradient(circle at 30% 50%, rgba(220,38,38,0.2) 0%, transparent 50%)' }} />
        <div className="relative mx-auto max-w-5xl px-4 sm:px-5 lg:px-8">
      ...
      <section className="relative bg-[#1a1515] py-16 sm:py-20 lg:px-8">
        ...
        <div className="relative mx-auto max-w-5xl gap-6 sm:gap-8 border border-[#ef4444]/20 bg-[#201515] p-6 sm:p-8 text-white lg:grid-cols-[1fr_auto] lg:flex shadow-[0_0_40px_rgba(220,38,38,0.1)]">
