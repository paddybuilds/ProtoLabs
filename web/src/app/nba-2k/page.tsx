  ...
  return (
    <main className="min-h-screen bg-[#0e0e10] text-[#efeff1]">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="mx-auto flex h-16 sm:h-20 max-w-7xl items-center justify-between px-4 sm:px-5 lg:px-8">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <span className="text-white/20 text-xs">|</span>
            <a href="/nba-2k" className="px-2.5 sm:px-3.5 py-1.5 rounded text-sm sm:text-base font-bold tracking-widest text-[#f97316]">NBA 2K</a>
            <span className="text-white/20 text-xs">|</span>
          ...
          <div className="flex items-center gap-2">
            <MobileNav
              sportLinks={[
                ...
                { href: "/nba-2k", label: "NBA 2K", isActive: true },
                { href: "/pga", label: "PGA" },
              ]}
              accentColor="#f97316"
            />
      ...
      <section className="relative bg-[#1a1208] py-16 sm:py-20 lg:px-8">
        ...
        <div className="relative mx-auto max-w-5xl border border-[#f97316]/20 bg-[#201510] p-6 sm:p-8 text-white shadow-[0_0_40px_rgba(249,115,22,0.1)]">
